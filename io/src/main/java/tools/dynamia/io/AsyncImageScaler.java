...
import tools.dynamia.io.ImageScaler.Method;
import tools.dynamia.io.ImageScaler.Rotation;
import tools.dynamia.io.ImageScaler.Mode;

/**
 * Class used to provide the asynchronous versions of all the methods defined in
 * {@link ImageScaler} for the purpose of efficiently handling large amounts of image
 ...
 * that the scale operations performed by imgImageScaler be manageable so as not to
 ...
 * or limiting logic to handle these use-cases. Given imgImageScaler's popularity in
 * web applications it was determined that this requirement be common enough
 * that it should be integrated directly into the imgImageScaler library for everyone
 * to benefit from.
 * <p/>
 * Every method in this class wraps the matching methods in the {@link ImageScaler}
 ...
 * <p/>
 * If you have used the {@link AsyncImageScaler} class and are trying to shut down a
 ...
 * <h3>Reusing Shutdown AsyncImageScaler</h3>
...
public class AsyncImageScaler {
     ...
     * operations.
     * <p/>
     * Value is "<code>imgImageScaler.async.threadCount</code>".
     */
    public static final String THREAD_COUNT_PROPERTY_NAME = "imgImageScaler.async.threadCount";
     ...
     * <code>imgImageScaler.async.threadCount</code> system property (see
    ...
    /**
     * @see ImageScaler#apply(BufferedImage, BufferedImageOp...)
     */
    public static Future<BufferedImage> apply(final BufferedImage src,
        ...
        return service.submit(() -> ImageScaler.apply(src, ops));
    }

    /**
     * @see ImageScaler#crop(BufferedImage, int, int, BufferedImageOp...)
     */
    public static Future<BufferedImage> crop(final BufferedImage src,
        ...
        return service.submit(() -> ImageScaler.crop(src, width, height, ops));
    }

    /**
     * @see ImageScaler#crop(BufferedImage, int, int, int, int, BufferedImageOp...)
     */
    public static Future<BufferedImage> crop(final BufferedImage src,
        ...
        return service.submit(() -> ImageScaler.crop(src, x, y, width, height, ops));
    }

    /**
     * @see ImageScaler#pad(BufferedImage, int, BufferedImageOp...)
     */
    public static Future<BufferedImage> pad(final BufferedImage src,
        ...
        return service.submit(() -> ImageScaler.pad(src, padding, ops));
    }

    /**
     * @see ImageScaler#pad(BufferedImage, int, Color, BufferedImageOp...)
     */
    public static Future<BufferedImage> pad(final BufferedImage src,
        ...
        return service.submit(() -> ImageScaler.pad(src, padding, color, ops));
    }

    /**
     * @see ImageScaler#resize(BufferedImage, int, BufferedImageOp...)
     */
    public static Future<BufferedImage> resize(final BufferedImage src,
        ...
        return service.submit(() -> ImageScaler.resize(src, targetSize, ops));
    }

    /**
     * @see ImageScaler#resize(BufferedImage, Method, int, BufferedImageOp...)
     */
    public static Future<BufferedImage> resize(final BufferedImage src,
        ...
        return service.submit(() -> ImageScaler.resize(src, scalingMethod, targetSize, ops));
    }

    /**
     * @see ImageScaler#resize(BufferedImage, Mode, int, BufferedImageOp...)
     */
    public static Future<BufferedImage> resize(final BufferedImage src,
        ...
        return service.submit(new Callable<BufferedImage>() {
            public BufferedImage call() throws Exception {
                return ImageScaler.resize(src, resizeMode, targetSize, ops);
            }
        });
    }

    /**
     * @see ImageScaler#resize(BufferedImage, Method, Mode, int, BufferedImageOp...)
     */
    public static Future<BufferedImage> resize(final BufferedImage src,
        ...
        return service.submit(() -> ImageScaler.resize(src, scalingMethod, resizeMode, targetSize,
                ops));
    }

    /**
     * @see ImageScaler#resize(BufferedImage, int, int, BufferedImageOp...)
     */
    public static Future<BufferedImage> resize(final BufferedImage src,
        ...
        return service.submit(new Callable<BufferedImage>() {
            public BufferedImage call() throws Exception {
                return ImageScaler.resize(src, targetWidth, targetHeight, ops);
            }
        });
    }

    /**
     * @see ImageScaler#resize(BufferedImage, Method, int, int, BufferedImageOp...)
     */
    public static Future<BufferedImage> resize(final BufferedImage src,
        ...
        return service.submit(() -> ImageScaler.resize(src, scalingMethod, targetWidth,
                targetHeight, ops));
    }

    /**
     * @see ImageScaler#resize(BufferedImage, Mode, int, int, BufferedImageOp...)
     */
    public static Future<BufferedImage> resize(final BufferedImage src,
        ...
        return service.submit(() -> ImageScaler.resize(src, resizeMode, targetWidth, targetHeight, ops));
    }

    /**
     * @see ImageScaler#resize(BufferedImage, Method, Mode, int, int,
     *      BufferedImageOp...)
     */
    public static Future<BufferedImage> resize(final BufferedImage src,
                                               final Method scalingMethod, final Mode resizeMode,
        ...
        return service.submit(() -> ImageScaler.resize(src, scalingMethod, resizeMode,
                targetWidth, targetHeight, ops));
    }

    /**
     * @see ImageScaler#rotate(BufferedImage, Rotation, BufferedImageOp...)
     */
    public static Future<BufferedImage> rotate(final BufferedImage src,
        ...
        return service.submit(() -> ImageScaler.rotate(src, rotation, ops));
    }
     ...
     * by {@link AsyncImageScaler} to process images, but don't want to have to write
     * the implementation.
     *
     * @author Riyad Kalla (software@thebuzzmedia.com)
     * @since 4.0
