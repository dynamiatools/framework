 ...
 * <h3>Thread Safety</h3>
 * The {@link ImageScaler} class is <strong>thread-safe</strong> (as all the methods
...
public class ImageScaler {
	...
	public static enum Method {
		 ...
		 * {@link ImageScaler#THRESHOLD_QUALITY_BALANCED} or
		 * {@link ImageScaler#THRESHOLD_BALANCED_SPEED} thresholds as cut-offs to
	...
	public static enum Mode {
		 ...
		 * 
		 * See "Image Proportions" in the {@link ImageScaler} class description for
		 * more detail.
		 */
		AUTOMATIC,
		/**
	 ...
	 * {@link ImageScaler#DEBUG} is <code>true</code>; otherwise the VM will be
	 ...
	 * 
	 * @see ImageScaler#LOG_PREFIX
	 * @see ImageScaler#LOG_PREFIX_PROPERTY_NAME
	 */
	protected static void log(int depth, String message, Object... params) {
		if (ImageScaler.DEBUG) {
			System.out.print(ImageScaler.LOG_PREFIX);
	 ...
	 * method utilizes the {@link ImageScaler#THRESHOLD_QUALITY_BALANCED} and
	 * {@link ImageScaler#THRESHOLD_BALANCED_SPEED} thresholds when selecting which
	...
	protected static Method determineScalingMethod(int targetWidth,
		...
		if (length <= ImageScaler.THRESHOLD_QUALITY_BALANCED)
			result = Method.QUALITY;
		else if (length <= ImageScaler.THRESHOLD_BALANCED_SPEED)
