...
/**
 * Automatically remove metaClass field from Groovy classes.
 *
...
public class GroovyMetaClassFieldCustomizer implements FieldCustomizer {
    ...
    /* (non-Javadoc)
	 * @see com.dynamia.tools.viewers.FieldCustomizer#customize(java.lang.String, com.dynamia.tools.viewers.Field)
     */
    @Override
