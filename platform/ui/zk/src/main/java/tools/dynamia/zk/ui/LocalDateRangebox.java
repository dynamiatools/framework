...
public class LocalDateRangebox extends Span {


    private LocalDateRange value;
    private final Datebox start;
    private final Datebox end;


    public LocalDateRangebox() {
        this(null);
    }

    public LocalDateRangebox(LocalDateRange value) {
    ...
    public LocalDateRange getValue() {
        if (value == null) {
            value = new LocalDateRange();
        }
        value.setStartDate(start.getValueInLocalDate());
        value.setEndDate(end.getValueInLocalDate());
        return value;
    }

    public void setValue(LocalDateRange value) {
        this.value = value;
        if (value != null) {
            start.setValueInLocalDate(value.getStartDate());
            end.setValueInLocalDate(value.getEndDate());
        }
    }
